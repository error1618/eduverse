<div class="panel panel-default" style="margin:10px">
            ...
            @if ($lang == 'es') 
            <div class="forms-container" style="flex-direction: row-reverse;">
        @else
        ...
        @endif
            ...
            &nbsp;<span style="display: inline-block; vertical-align: bottom;font-size:10px">  
        ...
        @elseif ($lang == 'en') Comment
        @endif
            

                </button>
        </form>   
        <hr color="grey" size="5" width="100%">         
</div>