...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{route('courses')}}">
            ...
            @if($lang=='en') Courses @else @if($lang=='fr') Cours  @elseif ($lang == 'es') الدروس @endif @endif
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{route('posts')}}">
              ...
              @if($lang=='en') Forum @else @if($lang=='fr') Forum @elseif ($lang == 'es') المنتدى @endif @endif
          </a>
      </li>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{route('people')}}">
            ...
            @if($lang=='en') Community @else @if($lang=='fr') Rencontres @elseif ($lang == 'es') مجتمع @endif @endif
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{route('profile.show')}}">
            ...
            @if($lang=='en') Profile @elseif($lang=='fr') Profil @elseif ($lang == 'es') ملفي شخصي  @endif
          </a>
        </li>
      
        
        <li class="nav-item">
          <a class="nav-link gc"  href="{{route('groupchat')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            @if($lang=='en') Group Chat @else @if($lang=='fr') Chat en groupe @elseif ($lang == 'es')  المجموعات @endif @endif
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{route('logout')}}">
            ...
            @if($lang=='en') Logout @else @if($lang=='fr') Se déconnecter @elseif ($lang == 'es') تسجيل الخروج @endif @endif
</span>          </a>
        </li>
 ...
 <span class="d-sm-inline d-none"></span>
            ...
            <li class="nav-item d-xl-none ps-3 pe-0 d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-BL p-0">
...
/*    document.addEventListener('contextmenu', function (event) {
    ...
    document.getElementsByClassName('gc')[0].onclick = function () {
      alert('Comming Soon !')
    };*/
    </script>
