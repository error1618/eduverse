...
<li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                  ...
                  <a wire:click="$emit('showMessages', {{ $user->id }})" class="btn btn-link pe-3 ps-0 mb-0 ms-auto" href="javascript:;">
                    @if ($lang == 'fr') Reply
...
<div class="overlay" id="overlayit">
       ...
       <!-- <a id="close-bar" id="close-overlay" style="top:0;position:absolute;right:0;margin:5px;padding:10px;float:right;">×</a>-->
                 ...
                 <a href="mailto:minassat.VIRTED@gmail.com?subject=Error in detection" style="background: linear-gradient(to bottom right, #ff0000, #ff6a00);color:white"  class="btn btn-red mb-0 me-2" target="_blank"><i class="fab me-1" aria-hidden="true"></i>report error</a>
        </div>
</div>
