<x-form-section submit="updatePassword">
    ...
    <x-slot name="form">
        <div class="">
            ...
            <x-input-error for="current_password" class="mt-2 form-control " />
        </div>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input-error for="password" class="mt-2 form-control " />
        </div>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input-error for="password_confirmation" class="mt-2 form-control " />
        </div>
    </x-slot>
