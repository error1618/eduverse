 ...
 @endphp
    ...
    <x-slot name="form" >
        ...
        <div class="" style="margin-top: 0%">
            ...
            <x-input id="name" type="text" class="mt-1 block w-full form-control " wire:model.defer="state.name" autocomplete="name" />
            <x-input-error for="name" class="mt-2 form-control " />
        </div>
